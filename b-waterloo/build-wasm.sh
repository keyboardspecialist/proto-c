#!/bin/sh
# Build the b-waterloo B compiler to wasm (emscripten), matching the C compilers'
# packaging: an ES6 module whose factory callMain's the compiler over a MEMFS
# source file, printing WAT to stdout. Default output: ./cfront-bw.mjs.
...
echo "done -> $out/cfront-bw.{mjs,wasm}"
